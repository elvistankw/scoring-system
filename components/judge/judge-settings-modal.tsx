...
// Judge Settings modal component
// Provides theme selection only (no language selection for judges)

import { useState, useEffect } from 'react';
import { useTheme } from '../shared/theme-provider';
import { useTranslation } from '@/i18n/use-dictionary';

interface JudgeSettingsModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export function JudgeSettingsModal({ isOpen, onClose }: JudgeSettingsModalProps) {
  ...
  return (
    <>
      ...
      <div
        className="fixed inset-0 bg-black/20 backdrop-blur-sm z-50 transition-all duration-300 !mt-0"
        onClick={handleClose}
        aria-hidden="true"
      />
